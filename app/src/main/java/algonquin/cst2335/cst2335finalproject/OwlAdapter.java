...
public class OwlAdapter extends RecyclerView.Adapter<OwlAdapter.Holder> {
    ...
    @NonNull
    @Override
    public OwlAdapter.Holder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.owl_item_saved, parent, false);
        return new Holder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull OwlAdapter.Holder holder, int position) {
